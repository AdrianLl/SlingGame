...
/**
 * This class will control all animations
 * 
 * Animation will take images rendered from textures will run an animation loop.
 * Parameters used are speed, frames (numbers of frames), and the actual images
 * 
 */
